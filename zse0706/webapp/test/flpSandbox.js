		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TrainUI",
									"targetURL": "#Trainzse0706-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Trainzse0706-display": {
								"semanticObject": "Trainzse0706",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Train.zse0706",
									"url": sap.ui.require.toUrl("Train/zse0706")
								}
							}
						}
					}
