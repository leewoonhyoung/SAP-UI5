		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "quiz",
									"targetURL": "#quizzse07quiz-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"quizzse07quiz-display": {
								"semanticObject": "quizzse07quiz",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=quiz.zse07quiz",
									"url": sap.ui.require.toUrl("quiz/zse07quiz")
								}
							}
						}
					}
