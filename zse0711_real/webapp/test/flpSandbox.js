		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "gwandoData",
									"targetURL": "#synczse0711real-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synczse0711real-display": {
								"semanticObject": "synczse0711real",
								"action": "display",
								"description": "sync",
								"title": "gwandoData",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zse0711real",
									"url": sap.ui.require.toUrl("sync/zse0711real")
								}
							}
						}
					}
